...
* <BR><BR>History:<UL>
* <li>
* <li>05-04-2005				: bugfixes in findFirstMatchingStatement() and findFirstMatchOff;
* <li>01-26-2005				: small bugfix in findFirstMatchingStatement();
* <LI>12-06-2004                 : improved namespace handling added (tobias.gauss@web.de)</LI>
* <LI>10-07-2004				 : Function findFirstMatchingStatement() added paramter $offset
*                                 to set an search offset
* <LI>09-09-2004				 : Function remove() bug removed: now removes ALL matching statements.
Function addWithoutDuplicates() now uses the contains() / add() functions.
Functions reify(),addModel(),unite(),subtract() changed to use the statement iterator.</LI>
* <LI>16-08-2004				 : Function getUniqueResourceURI() has been made faster</LI>
* <LI>08-06-2004                : Function findAsIterator() added</LI>
* <LI>06-13-2004                : Improved function index() which allows the definition of different search indexes</LI>
