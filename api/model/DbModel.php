...
* This Class uses ADOdb Library for PHP V3.60 (http://php.weblogs.com/ADODB).
*
* <BR><BR>History:<UL>
* <LI>01-21-2006                 : function iterFind() added (tobias.gauss@web.de)</LI>
...
* 								   addWithoutDuplicates() added</LI>
* <LI>05-24-2004				 : Bug in _getNodeFlag() fixed (auer@informatik.uni-leipzig.de)</LI>
* <LI>03-29-2004				 : Function addModel() fixed, saveAs() added</LI>
* <LI>11-13-2003		 		 : Functions load,saveAs moved to class model
* <LI>11-12-2003		 		 : Function rdqlQueryAsIterator() added.</LI>
* <LI>06-17-2003                : First version of this class</LI>
*
* @version  V0.9.3
