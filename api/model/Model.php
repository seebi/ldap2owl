 ...
 *
 * <BR><BR>History:<UL>
 * <LI>01-05-2006                 : Function sparqlQuery() added (tobias.gauss@web.de)</LI>
 * <LI>03-29-2005                 : Function visualizeGraph() added (anton1@koestlbacher.de)</LI>
 * <LI>12-06-2004                : Functions findForward() and getMemModelByRDQL() added. (anton1@koestlbacher.de) </LI>
 * <LI>10-30-2004                : GRDDL-Support (see http://www.w3.org/TR/grddl/) added. (tobias.gauss@web.de) </LI>
 * <LI>09-22-2004				 : Function getUniqueResourceURI(): default bNode prefix is used,
 *								   if no other is defined. Returns unique URIs, without checking the model first.
 * <LI>09-07-2004                : Function load improved. (auer@informatik.uni-leipzig.de)</LI>
