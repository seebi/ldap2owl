 ...
 *
 * <BR><BR>History:<UL>
 * <LI>05-12-2004				 : Support for unquoted QNames added. 
 *								   However, backward compatibility is provided, that means, 
 *								   both prefix:local_name and <prefix:local_name> are allowed.
 *								   In the case of unquoted QNames, the parser now also checks 
 *								   if a prefix is defined in the USING clause.
 *								   changes: - the stracture of the class variable $parsedQuery
 *										    - methods: parseFrom(), parseExpressions(), replaceNamespacePrefixes(),
 *											  _validateVarUri(), _validateVarUriLiteral(), _validateUri(),  
 *											  _validateLiteral(), _validatePrefix()
 *								   methods added: _validateQName(), _validateNCName(), _replaceNamespacePrefix()
 *								 : Bug in the handling of empty Literals fixed.</LI>
 * <LI>07-27-2003                : First release of this class</LI>
 *
 * @version  V0.9.3
