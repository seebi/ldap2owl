 ...
 * <LI>08-13-2004				 : Bug in rdf:resource="" fixed</LI>
 * <LI>08-10-2004                : function for converting strings to its unicode NFC form added. Benjamin Nowack <bnowack@appmosphere.com></LI>
 * <LI>06-01-2004				 : Bug in xml:lang fixed, some bugs in the handling of collections fixed</LI>
 * <LI>05-03-2004				 : generateModel(): added optional parameter $rdfBaseURI to set the rdf base URI manually for strings when there's
 *										no xml:base stated <mail@d-westphal.de>.</LI>
 * <LI>11-18-2003				 : Made compliant with the latest RDF Specification (10. October 2003) <radol@gmx.de>.
 *
 ...
 *								   		- correct handling of non US-ASCII characters</LI>
 *							   	
 * <LI>07-27-2003                : Functions addapted to the new class tree (MemModel extends Model)</LI>
 * <LI>04-23-2003                : Bug concerning bnode recognition fixed.</LI>
 * <LI>04-03-2003                : Bug concerning bnode identifier generation fixed.</LI>
 * <LI>01-10-2003                : Support for rdf:datatype and rdf:nodeID added.</LI>
 * <LI>01-05-2003                : Support for rdf:seeAlso added.</LI>
 * <LI>11-07-2002                : Possibility to pass RDF code  directly to the method generateModel() added.</LI>
 * <LI>10-25-2002                : Bug concerning 1 character long literals fixed.</LI>
 * <LI>09-24-2002                : Recognition of blank nodes improved.</LI>
